...
select '<year/>','<Month/>',E.EmpID,E.CBName,E.DeptCode,(@i+1),'1',K.WorkFTime
   	,  datediff(n,(CONVERT(varchar(100),  @FDate, 23)+' '+K.TurnFTime),(CONVERT(varchar(100),  @FDate, 23)+' '+K.WorkFTime)) as lateFTime
   	,FDate
...
Union All
	...
	, datediff(n,(CONVERT(varchar(100),  @FDate, 23)+' '+K.TurnFTime),(CONVERT(varchar(100),  @FDate, 23)+' '+K.WorkFTime)) as lateFTime,FDate
