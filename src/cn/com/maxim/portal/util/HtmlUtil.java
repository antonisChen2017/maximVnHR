...
public class HtmlUtil
{
	...
	{
		StringBuilder Sb = new StringBuilder("<!-- BEGIN PAGE ROW--> \r").append("<div class=\"row \"> \r")
				.append("<div class=\"col-md-12 col-sm-12\"> \r").append("<div class=\"portlet no-border\"> \r")
				.append("<div class=\"tab-pane\" id=\"tab_form_1\"> \r").append("<div class=\"portlet\"> \r")
				.append(" <div class=\"portlet-title\"> \r")
				.append("  <div class=\"caption\"> <i class=\"fa fa-search\"></i>" + title + "</div> \r")
				.append("  <div class=\"tools\"> <a href=\"javascript:;\" class=\"collapse\"></a>  </div> \r")
				.append("</div> \r").append("<div class=\"portlet-body form\">  \r").append("  <!-- BEGIN FORM--> \r");
	...
	{
		StringBuilder Sb = new StringBuilder(" <!-- END FORM-->   \r").append("</div>  \r").append("</div>  \r")
		.append("<script type=\"text/javascript\"> \r")
		.append(" function    saveData(){  \r")
		.append("		if($('#SearchReasons').val()=='0'){  \r")
		.append("				alert('請選擇加班事由');  \r")
		.append("				return;  \r")
		.append("		}  \r")
		
		.append("		if($('#SearchUnit').val()=='0'){  \r")
		.append("				alert('請選擇單位');  \r")
		.append("				return;  \r")
		.append("		}  \r")
		
		.append("		if($('#startTimeHh').val()=='00'){  \r")
		.append("				alert('請選擇開始時間');  \r")
		.append("				return;  \r")
		.append("		}  \r")
		
		.append("		if($('#endTimeHh').val()=='00'){  \r")
		.append("				alert('請選擇結束時間');  \r")
		.append("				return;  \r")
		.append("		}  \r")
		
		.append("		if($('#addTime').val()=='0'){  \r")
		.append("				alert('請選擇總共小時');  \r")
		.append("				return;  \r")
		.append("		}  \r")
		
		.append("		if($('#SearchEmployee').val()=='0'){  \r")
		.append("				alert('請選擇姓名工號');  \r")
		.append("				return;  \r")
		.append("		}  \r")
		.append("		  \r")
		.append("		ActionForm.act.value='Save';  \r")
		.append("		ActionForm.submit();   \r")

		.append("	}  \r")
		
		.append(" function    queryData(){  \r")
		
		.append("		if($('#SearchDepartmen').val()=='0'){  \r")
		.append("				alert('請選擇部門');  \r")
		.append("				return;  \r")
		.append("		}  \r")
	
		.append("		ActionForm.act.value='QUE';  \r")
		.append("		ActionForm.submit();   \r")
	...
	{
		StringBuilder Sb = new StringBuilder(" </div> \r").append("</div>\r").append("  <!-- END PAGE CONTENT --> \r")
				.append("</div>\r").append("<!-- END PAGE CONTAINER -->  <!-- BEGIN FOOTER --> \r")
				.append("<div id=\"footer\" class=\"footer\"> \r").append("<div class=\"footer-inner\"> </div> \r")
				.append("<div class=\"footer-tools\"></div> \r").append("<!-- END FOOTER -->  \r").append("</div> \r")
				.append("<!-- END WRAPPER -->  \r");
	...
	{
		StringBuilder Sb = new StringBuilder("<!-- BEGIN PAGE CONTAINER --> \r")
				.append("<div id=\"content\" class=\"page-container\">  \r").append("<!-- BEGIN PAGE CONTENT -->  \r")
				.append("<div class=\"page-content-wrapper\">   \r").append("<!-- END TICKER-->  \r")
				.append("<div class=\"page-content fullwidth\">   \r").append("  <!-- BEGIN PAGE HEADER-->  \r")
				.append(" <div class=\"row\">   \r").append("   <!-- BEGIN PAGE TITLE-->  \r")
				.append("   <h3 class=\"page-title\">" + title + "<small>" + subTitle + "</small> </h3>  \r")
				.append("   <!-- END PAGE TITLE-->   \r").append(" </div>  \r")
				.append("<div class=\"clearfix\"> </div>\r").append("<!-- END PAGE ROW--> \r");
	...
	public static final String getDateDivSw(String startID, String endID, String startValue, String endValue)
	{
		...
		StringBuilder Sb = new StringBuilder("")
				...
				.append("    <div class=\"input-group input-large date-picker input-daterange\" data-date=\"10/11/2012\" data-date-format=\"yyyy/mm/dd\"> \r")
				.append("     <input type=\"text\"  ID='" + startID + "'  name='" +startID  	+ "'  class=\"form-control\" name=\"from\"   value='" + startValue  + " '> \r")
				.append("      <span class=\"input-group-addon\"> 至 </span> \r")
				.append("     <input type=\"text\"  '" + endID + "'  name='" +endID  	+ "' class=\"form-control\" name=\"to\"    value='" + endValue + "' > \r")
				.append("    </div> \r");
	 ...
	 * @return
	 */
	public static final String getTimeDiv(String StartID, String EndID, String StartTime, String EndTime
			,overTimeVO otVo)
	{
		...
		StringBuilder Sb = new StringBuilder("").append("<div  id='changeTimeDiv' class=\"row\">\r").append("<div class=\"col-md-5\"><div class=\"col-md-4\"> \r")
				...
				.append("開始時間</div> \r").append("<div class=\"col-md-3\"> \r")
				.append("<SELECT class=\"form-control\" name='startTimeHh' id='startTimeHh'>  \r");
		...
		Sb.append("<div class=\"col-md-4\">結束時間</div> \r");
	 ...
	 * @return
	 */
	public static final String getStopWorkTimeDiv(String StartID, String EndID, String StartTime, String EndTime
			,overTimeVO otVo)
	{
		String startTimeHh=otVo.getStartTimeHh();
		String startTimemm=otVo.getStartTimemm();
	 ...
	 * @return
	 */
	public static final String getSpinnerDiv(String ID,String value)
	{
		StringBuilder Sb = new StringBuilder("")
				.append("<input id='" + ID + "' name='" + ID
						+ "'   type=\"text\" class=\"form-control\" value=\""+value+"\" > \r")
				.append("<script type=\"text/javascript\"> \r").append("$(function(){ \r")
				.append("$( \"#" + ID + "\" ).spinner({ \r").append("	   max:10, \r").append("		min:1, \r")
				.append("		step:1 \r").append("	}); \r").append("	}); \r").append("	</script> \r");
	...
	public static final String getJsDwGearingDiv(String DwID1, String DwID2)
	{
		StringBuilder Sb = new StringBuilder("")
				.append("<script type=\"text/javascript\"> \r")
				.append(" $(document).ready(function(){  \r")
				.append("    $('#" + DwID1 + "').change(function(){  \r")
				.append("	     var p1=$(this).children('option:selected').val();  //这就是selected的值  \r")
				.append("     $('#" + DwID2 + "').val(p1);       \r")
				.append("	   })  \r")
				.append("    $('#" + DwID2 + "').change(function(){  \r")
				.append("	     var p1=$(this).children('option:selected').val();  //这就是selected的值  \r")
				.append("     $('#" + DwID1 + "').val(p1);       \r")
				.append("	   })  \r")
				.append("	})   \r")
				.append("	</script> \r");
	...
	public static final String getSaveStatusJs(){
		...
		.append("<script type=\"text/javascript\"> \r")
		.append(" $(document).ready(function(){  \r")
		.append("		var Status=$('#Status').val();  \r")
		//.append("		alert('Status :' +Status) \r")
		.append("	if( Status=='U'){ \r")
		.append("		$('#saveBut').attr('disabled','disabled')  \r")
		//.append("		alert('disabled :' +disabled) \r")
		.append("		} \r")
		.append("	if( Status=='I'){ \r")
		.append("		$('#saveBut').attr('disabled','disabled')  \r")
		//.append("		alert('disabled :' +disabled) \r")
		.append("		} \r")
		.append("		 \r")
...
public static final String getListStatusJs(){
		...
		//.append("		alert('Status :' +Status) \r")
		.append("	if( Status=='U'){ \r")
		.append("		$('#ReferBut').attr('disabled','disabled')  \r")
		//.append("		alert('disabled :' +disabled) \r")
		.append("		} \r")
		.append("	if( Status=='I'){ \r")
		.append("		$('#ReferBut').attr('disabled','disabled')  \r")
	...
	public static String drawTableM(String sqlTotal, String sql, String sqlStatus,String htmlButton ,Connection con, PrintWriter out,String page)
			throws SQLException
	{
		...
		return table.getHTMLTable(out, "table table-striped table-bordered table-hover",
				msg, htmlButton,bStatus);
	...
	public static String drawTableS( String sql,String htmlButton ,Connection con, PrintWriter out,String page)
			throws SQLException
	{
		String totalTime = "", resultS = "", Status = "";
		String css="table table-striped table-bordered table-hover";
	...
	public static String drawLeaveCardTable( String sql,String htmlButton ,Connection con, PrintWriter out,String page)
			throws SQLException
	{
		String totalTime = "", resultS = "", Status = "";
		String css="table table-striped table-bordered table-hover";
	...
	public static final String getDaterangeHtml (String startStopWorkDate,String endStopWorkDate, String startStopWorkTime, String endStopWorkTime){
		...
		System.out.println("startStopWorkTime :"+startStopWorkTime);
		for (int i = 0; i <=23; i++)
		{
			if (i <= 9)
			{
	...
	public static String drawStopWorking( String sql,String htmlButton ,Connection con, PrintWriter out,String page)
			throws SQLException
	{
		String totalTime = "", resultS = "", Status = "";
		String css="table table-striped table-bordered table-hover";
  ...
  public static String getYear(lateOutEarlyVO eaVo ){
	...
	/*	ArrayList Options=new ArrayList();
		for(int i=2017;i<2037;i++){
			Hashtable ht=new Hashtable();
			 ht.put("value",String.valueOf(i));
			 ht.put("text", String.valueOf(i));
			Options.add(ht);
		}
	*/
